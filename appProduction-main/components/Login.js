...
export default function Login({ route, navigation }) {
    ...
    if (!user) return (
        <View style={styles.container}>
            <Text style={{ fontSize: 20, color: 'white' }}>Agilidade e praticidade</Text>
            <Text style={{ fontSize: 20, color: 'white' }}>para a estética</Text>
            <Text style={{ fontSize: 26, padding: 20, color: 'white' }}>Clube <Text style={{ fontSize: 33, fontWeight: "bold", padding: 25, color: '#AC08A4' }} >PyBeeT</Text></Text>
